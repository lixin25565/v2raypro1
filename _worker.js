...
let userID = 'ca012d09-1d95-4b3b-bb7f-846df4b37510';

let proxyIP = 'cdn.xn--b6gac.eu.org';// 小白勿动，该地址并不影响你的网速，这是给CF代理使用的。'cdn.xn--b6gac.eu.org, cdn-all.xn--b6gac.eu.org, workers.cloudflare.cyou'

//let sub = '';// 留空则显示原版内容
let sub = 'sub.nohqn5.eu.org';// 内置优选订阅生成器，可自行搭建 https://github.com/cmliu/WorkerVless2sub
